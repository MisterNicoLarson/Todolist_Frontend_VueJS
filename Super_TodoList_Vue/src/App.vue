...
const tasksInProgress = ref<{ id: number, taskData: { taskName: string, deadline: string, hour: string }, isEmpty: boolean, isTaskNameEmpty: boolean, isDeadlineEmpty: boolean, isHourEmpty: boolean, isEditable: boolean, backgroundColor: string }[]>([]);
const tasksDone = ref<{ id: number, taskData: { taskName: string, deadline: string, hour: string }, isEmpty: boolean, isTaskNameEmpty: boolean, isDeadlineEmpty: boolean, isHourEmpty: boolean, isEditable: boolean, backgroundColor: string }[]>([]);
const tasksFailed = ref<{ id: number, taskData: { taskName: string, deadline: string, hour: string }, isEmpty: boolean, isTaskNameEmpty: boolean, isDeadlineEmpty: boolean, isHourEmpty: boolean, isEditable: boolean, backgroundColor: string }[]>([]);
const tasksTodo =  ref<{ id: number, taskData: { taskName: string, deadline: string, hour: string }, isEmpty: boolean, isTaskNameEmpty: boolean, isDeadlineEmpty: boolean, isHourEmpty: boolean, isEditable: boolean, backgroundColor: string }[]>([]);
let idTask = 0;
 ...
 */
 const getRandomColor = (): string => {
  const colors = ['#ffc733','#d871ed','#f0a85c','#caf05c','#5cf0d1','#f05c89','43abea'];
 ...
 */
const moveTask = (task: { id: number, taskData: { taskName: string, deadline: string, hour: string }, isEmpty: boolean, isTaskNameEmpty: boolean, isDeadlineEmpty: boolean, isHourEmpty: boolean, isEditable: boolean, backgroundColor: string }, status: string) => {
